    ...
    const schema = Joi.object().keys({
      ...
      realName: Joi.string()
        ...
        .error(() => {
          return {
            message:
              "O seu nome não é válido, não queremos descriminar desculpe lá"
          };
        }),
      password: Joi.string()
        ...
        .error(() => {
          return {
            message:
              "A password tem de ser entre 6 e 32 caracteres e conter apenas minusculas, maiusculas e numeros"
          };
        }),
